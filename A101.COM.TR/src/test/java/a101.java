...
public class a101 {
    ...
    {
        String email="zelihabakir79@gmail.com";
        String Value_="";
        String Color="";
        String adresshedar="Yukarıbayır";
        String name_="Zeliha";
        String surname_="Bakır";
        String phone_="5051234567";
        String openaddress="yukarıbayır mahallesi 14 nolu sok.no15 ";
